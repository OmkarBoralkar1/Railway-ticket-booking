    ...
    public static void main(String[] args) {
       ...
       //dffgrggbfggbrgbgbgbgbgrbrgbgfbngfnbf
        ...
        for(int i=0;i<n;i++){
            ...
            System.out.println(" 4 for 3Tire");
            System.out.println(" 5 for 2Tire");
            System.out.println(" 6 for  1Tire"); 
            System.out.println(" 7 for ACChairCar "); 
            System.out.println(" 8 for ExecitiveChairCar");  
            System.out.println(" 9 for Vistadome ");
            System.out.println(" 10 for  Anubhuti, "); 
            System.out.println(" 11 for  Sleeper");
            System.out.println(" 12 for  Second Sitting ");
            d[i]=sc.next();
